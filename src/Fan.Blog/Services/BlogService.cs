...
namespace Fan.Blog.Services
{
    public partial class BlogService : IBlogService
    {
        ...
        public async Task SetupAsync()
        {
            ...
            const string WELCOME_POST_BODY = "<p>Welcome and congrats on getting Fanray up and running! &nbsp;Fanray v1.0 was a minimal viable blog; you could only post through a client like the Open Live Writer. Fanray v1.1 builds on v1 and introduces a brand new Admin Console, you can now do more! &nbsp;Here are a few highlights.</p><h3>Admin Console</h3><p>The <a href=\"/admin/compose\">new composer </a>is where you\u2019d spend most of your time writing, so I\u2019ve written <a href=\"https://github.com/FanrayMedia/Fanray/wiki/Using-the-Composer\">a wiki page</a> to help you be productive posting commonly used contents. &nbsp;</p><p>The <a href=\"/admin/media\">media gallery</a> gives you a grand view of all your blog images. &nbsp;Here you can upload by simply drag and drop images and edit their info.</p><p>The <a href=\"/admin/categories\">categories </a>and <a href=\"/admin/tags\">tags</a> managers allow you to easily CRUD on these classification information, not something you could do with OLW.&nbsp;</p><p>The <a href=\"/admin/settings\">settings </a>page is where you could setup Google Analytics and Disqus for comments among other things.</p><h3>Azure</h3><p>When you are ready to run this app on Azure, I have a couple of posts that may interest you.</p><ul><li><a href=\"https://www.fanray.com/post/3\">Set up Fanray on Azure App Service</a></li><li><a href=\"https://fanray.com/post/18\">Production deployment with Azure App Service slots and Entity Framework Core migrations</a></li></ul><h3>Share &amp; Contribute</h3><p>I created Fanray to learn new techs, share best practices and build a product with usability in mind for end users. &nbsp;Admittedly there will always be improvements, so please let me know what you think <a href=\"https://twitter.com/FanrayMedia\">@fanraymedia</a> and possibly <a href=\"https://github.com/FanrayMedia/Fanray/issues\">contribute</a>.</p><p>Happy coding :)</p>";
